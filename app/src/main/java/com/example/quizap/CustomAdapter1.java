...
public class CustomAdapter1 extends RecyclerView.Adapter<CustomAdapter1.MyViewHolder> {
    ...
    CustomAdapter1(Context context, ArrayList user_id, ArrayList user_name, ArrayList user_score){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.myrow_leaderboard, parent, false);
