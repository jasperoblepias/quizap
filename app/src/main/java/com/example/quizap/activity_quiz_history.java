...
public class activity_quiz_history extends AppCompatActivity {


    private questionsHistoryGradeSchool questions = new questionsHistoryGradeSchool();
            ...
            public void onClick(View v) {
                if(questionNumber == questions.mQuestions.length){
                    if(getChoiceA.getText() == mAnswer){
                        ...
                        Intent intent = new Intent(activity_quiz_history.this, literature_results.class);
                        Bundle bundle = new Bundle();
                        bundle.putInt("finalScore",mScore);
                        intent.putExtras(bundle);
                        activity_quiz_history.this.finish();
