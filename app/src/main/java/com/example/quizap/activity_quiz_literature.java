...
public class activity_quiz_literature extends AppCompatActivity {


    private questionsLitGradeSchool questions = new questionsLitGradeSchool();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_literature);
            ...
            public void onClick(View v) {
                if(questionNumber == questions.mQuestions.length){
                    if(getChoiceA.getText() == mAnswer){
                        ...
                        Intent intent = new Intent(activity_quiz_literature.this, literature_results.class);
                        Bundle bundle = new Bundle();
                        bundle.putInt("finalScore",mScore);
                        intent.putExtras(bundle);
                        activity_quiz_literature.this.finish();
